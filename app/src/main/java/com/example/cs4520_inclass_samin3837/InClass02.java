        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (email.getText().toString().matches("") || (name.getText().toString().matches(""))) {
                    Toast.makeText(InClass02.this, "enter an email and name!", Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    Intent intentToDisplayActivity = new Intent(InClass02.this, DisplayActivity.class);
